...
def home(request):
	...
	if request.method == "POST" :
		...
		api_requests=requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" +zipcode+ "&distance=5&API_KEY=F5B5DEEE-9139-4F0E-BD85-2B9A1E62D279")
		...
		if api[0]["Category"]["Name"] == "Good":
			...
			category_discription= "(201 - 300)everyone may experience more serious health effects."
			category_color="veryunhealthy"
		elif api[0]["Category"]["Name"] == "Hazardous" :
			category_discription= "(301 - 500)Health warnings of emergency conditions. The entire population is more likely to be affected."
			category_color="hazardous"
			
		return render(request,"home.html",{"api":api,"category_discription":category_discription,"category_color":category_color})

	else:
		api_requests=requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=5&API_KEY=F5B5DEEE-9139-4F0E-BD85-2B9A1E62D279")
